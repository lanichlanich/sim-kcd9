                                ...
                                <div class="card-body">
                                    ...
                                    <div class="default-collapse collapse-bordered">
                                        <?php if ($this->session->role_id == 1 || $this->session->role_id == 3) { ?>
                                            <form method="post" action="<?php echo base_url('admin/mapel/spreadsheet_import'); ?>" class="mb-2" enctype="multipart/form-data">
                                            <?php } else { ?>
...
<?php foreach ($mapel as $um) : ?>
    <?php if ($this->session->role_id == 1 || $this->session->role_id == 3) { ?>
        <form action="<?php echo base_url(); ?>admin/mapel/update_mapel" method="post" enctype="multipart/form-data">
        <?php } else { ?>
        ...
        <?php foreach ($mapel as $hm) : ?>
            <?php if ($this->session->role_id == 1 || $this->session->role_id == 3) { ?>
                <form action="<?php echo base_url(); ?>admin/mapel/hapus_mapel" method="post" enctype="multipart/form-data">
                <?php } else { ?>
                    <form action="<?php echo base_url(); ?>mapel/hapus_mapel" method="post" enctype="multipart/form-data">
                    <?php } ?>
