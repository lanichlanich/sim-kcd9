    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-body">
                ...
                <section id="description" class="card">
                    <div class="card-header">
                        <h4 class="card-title">Import Data Nilai US SMK</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <?php
                            ...
                            ?>
                            <h6><i>Template Import Excel: <span class="text-danger"><a href="<?php echo base_url('template_file/import_nilai_smk.xlsx') ?>">import_nilai_sma_ips.xlsx</a></span></i></h6>
                            <div class="row" id="table-hover-row">
                                <?php if ($this->session->role_id == '1') { ?>
                                    <form method="post" action="<?php echo base_url('admin/importnilai/import_us_smk'); ?>" class="" enctype="multipart/form-data">
                                    <?php } else { ?>
                                        <form method="post" action="<?php echo base_url('importnilai/import_us_smk'); ?>" class="" enctype="multipart/form-data">
                                        <?php } ?>
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-content">
